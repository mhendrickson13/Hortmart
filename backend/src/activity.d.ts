export type ActivityEvent = 'user.registered' | 'user.login' | 'user.blocked' | 'user.unblocked' | 'enrollment.created' | 'lesson.started' | 'lesson.completed' | 'module.completed' | 'course.completed' | 'review.created' | 'user.created_by_admin' | 'seeked';
