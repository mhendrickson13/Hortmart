  ...
  return (
    <div className="flex items-center gap-2.5">
      <button
        onClick={() =>
          toast({
            title: t("admin.analyticsActions.exportComingSoon"),
            description: t("admin.analyticsActions.exportComingSoonDesc"),
            variant: "info",
          })
        }
      ...
      <button
        onClick={() =>
          toast({
            title: t("admin.analyticsActions.dateRangeComingSoon"),
            description: t("admin.analyticsActions.dateRangeComingSoonDesc"),
            variant: "info",
          })
        }
      ...
      >
        ...
        {t("admin.analyticsActions.dateRange")}
      </button>
    </div>
  );
}
